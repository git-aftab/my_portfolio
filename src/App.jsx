...
const App = () => {
  ...
  useEffect(() => {
    ...
    const runLoadingSequence = async () => {
      ...
      if (loaderRef.current) {
        await gsap.from(loaderRef.current, {
          scale: 1,
          opacity: 0.5,
          duration: 0.6,
          ease: "back.out(1.7)",
  ...
  // Separate effect for main content animations
  useEffect(() => {
      ...
      {isLoading && (
        ...
        >
          <div className="w-full max-w-2xl px-6">
            <div className="bg-black/90 border-2 border-[#00ff41] rounded-lg overflow-hidden shadow-2xl shadow-[#00ff41]/30">
              {/* Terminal Header */}
              <div className="bg-[#00ff41]/10 px-4 py-3 flex gap-2 border-b-2 border-[#00ff41]/30">
